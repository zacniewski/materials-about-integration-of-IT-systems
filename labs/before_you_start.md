# Zanim zaczniesz (Wymagane konta)

Aby móc w pełni zrealizować zadania przewidziane w ramach laboratoriów, będziesz potrzebować kont w poniższych serwisach. Zaleca się ich założenie przed rozpoczęciem Laboratorium 1.

### 1. GitHub ([github.com](https://github.com))
- **Zastosowanie:** System kontroli wersji, hosting repozytoriów, współpraca w zespole, automatyzacja CI/CD (GitHub Actions).
...
- **Wymagania:** Konto bezpłatne.
- **Wskazówka:** Konto będzie niezbędne od Laboratorium 7, kiedy zaczniemy pracę z konteneryzacją.
...
---
*Uwaga: Większość darmowych serwisów typu PaaS (jak Render) może wymagać weryfikacji tożsamości (np. za pomocą karty płatniczej), mimo że oferują darmowy plan. Proszę o zapoznanie się z regulaminem danego dostawcy.*
